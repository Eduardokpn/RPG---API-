...
namespace RpgApi.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Disputa>().HasKey(x => x.Id);

            modelBuilder.Entity<Disputa>().Property(x => x.DataDisputa).HasColumnName("Dt_Disputa");
            modelBuilder.Entity<Disputa>().Property(x => x.AtacanteId).HasColumnName("AtacanteId");
            modelBuilder.Entity<Disputa>().Property(x => x.OponenteId).HasColumnName("OponenteId");
            modelBuilder.Entity<Disputa>().Property(x => x.Narracao).HasColumnName("Tx_Narracao");
